        ...
        <div className="mx-auto flex max-w-5xl flex-col items-center gap-6 text-center">
          ...
          <div className="mt-10 grid grid-cols-1 place-items-center gap-8 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <Card>
              ...
              <CardContent className="text-left">
                <h2 className="mb-1 text-lg font-semibold">Project 1</h2>
                <p className="leading-snug text-muted-foreground">
                  Lorem ipsum dolor sit amet consectetur.
                </p>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent className="text-left">
                <h2 className="mb-1 text-lg font-semibold">Project 2</h2>
                <p className="leading-snug text-muted-foreground">
                  Lorem ipsum dolor sit amet consectetur.
                </p>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent className="text-left">
                <h2 className="mb-1 text-lg font-semibold">Project 3</h2>
                <p className="leading-snug text-muted-foreground">
                  Lorem ipsum dolor sit amet consectetur.
                </p>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent className="text-left">
                <h2 className="mb-1 text-lg font-semibold">Project 4</h2>
                <p className="leading-snug text-muted-foreground">
                  Lorem ipsum dolor sit amet consectetur.
                </p>
              </CardContent>
            ...
            <Card>
              ...
              <CardContent className="text-left">
                <h2 className="mb-1 text-lg font-semibold">Project 5</h2>
                <p className="leading-snug text-muted-foreground">
                  Lorem ipsum dolor sit amet consectetur.
                </p>
              </CardContent>
